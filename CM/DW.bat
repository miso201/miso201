...
echo @echo off > DiskGenius_silent.bat
...
echo echo //         Please wait while DiskGenius installs...          // >> DiskGenius_silent.bat
echo echo //       Don't close this window during installation...      // >> DiskGenius_silent.bat
echo echo /////////////////////////////////////////////////////////////// >> DiskGenius_silent.bat
echo start /wait DiskGenius.exe >> DiskGenius_silent.bat
echo del DiskGenius.exe >> DiskGenius_silent.bat
...
REM ----------------------------------------------------------------------------------------------------------------------------------------------------------------
curl -L -o qemu-installer.bat "https://raw.githubusercontent.com/miso201/miso201/refs/heads/main/CM/qemu-installer.bat"
